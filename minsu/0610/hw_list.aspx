    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="ctlBasicList" runat="server"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText ="과제제목" DataField="title"/>
                <asp:BoundField HeaderText="제출기한" DataField="deadline"/>
                <asp:BoundField HeaderText="상태" DataField="submit_state"/>
                <asp:ButtonField Text="조회" ButtonType="Button" HeaderText="조회" CommandName="cmd"/>
