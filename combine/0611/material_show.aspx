<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="material_show.aspx.cs" Inherits="WebApplication1.material_show" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="d_classname">
            <asp:Button ID="Button_Class" runat="server" Text="강의 자료실" />
        </div>
        ...
        <div id="d_container">
            ...
            <div id = "d_content">
                ...
                Height="100%" 
                Width="100%"
                ForeColor="Red" ReadOnly="True" OnTextChanged="contentBox_TextChanged"></asp:TextBox>
            </div>
        </div>

        <div id="d_bottom">
            <asp:Button ID="btnModify" runat="server" Text="수정" onclick="btnModifty_Click" />
