<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="material_write.aspx.cs" Inherits="WebApplication1.material_write" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="d_classname">
            <asp:Button ID="Button_Class" runat="server" Text="강의자료 작성" />
        </div>
    ...
    <div style ="margin-top : 30px; margin-left : 5%; width : 80%; height :max-content;">
