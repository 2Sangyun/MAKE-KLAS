<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="material_list.aspx.cs" Inherits="WebApplication1.material_list" %>
        ...
        <asp:GridView ID="ctlBasicList" runat="server"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText ="제목"
                         ...
                         DataNavigateUrlFormatString="material_show.aspx?current_id={1}&course_id={2}&notice_id={3}"
                         DataTextField="Title"
