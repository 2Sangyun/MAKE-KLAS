...
<body>
    <form id="form1" runat="server">
            ...
            <div class="dropdown">
                ...
                <div class="row">
                    <div class="column">
                        ...
                        <br />
                        <asp:Button ID="Button_kw" runat="server" Text="출석관리(KW출첵)" style="margin-top : 20px;"/>
                        <br />
                        <asp:Button ID="Button_lecture_plan" runat="server" Text="강의계획서 조회" style="margin-top : 20px;"/>
                    </div>
                    <div class="column">
                        <h3>강의종합정보</h3>
                        <asp:Button ID="Button_material" runat="server" Text="강의자료실" OnClick="goMaterialList"/>
                        <br />
                        <asp:Button ID="Button_notice" runat="server" Text="공지사항" OnClick="goNoticeList" style="margin-top : 20px;"/>
                        <br />
                        <asp:Button ID="Button_hw" runat="server" Text="과제 제출" OnClick="goHWList" style="margin-top : 20px;"/>
        ...
        <div id = "d_timetable">
            <div id="d1">              
                <asp:Label ID="Label1" runat="server" Text="2021년도 1학기 시간표" Font-Size="16px"  ></asp:Label>
            </div>
            <div id="d2">
        ...
        <div id="d_calendar">
            <asp:Calendar ID="Calendars" runat="server" BackColor="White" BorderColor="Black" 
                BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" 
                ForeColor="Black" NextMonthText=">" PrevMonthText="<" 
                ShowGridLines="false" Height="300px" Width="70%" style="margin-left : 15%;">
