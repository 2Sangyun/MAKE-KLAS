<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hw_show_submit.aspx.cs" Inherits="WebApplication1.hw_show_submit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="d_container">
            ...
            <div id="d_homework">
                제목 : <asp:Label ID="submitTitle" runat="server" ForeColor="Red"></asp:Label><br />
                파일 : <asp:Button ID="submitdownBtn" runat="server" OnClick="submitdownBtn_Click" /><br />
                <asp:TextBox 
                    ID="submitcontentBox" 
                    runat="server" 
                    ForeColor="Red">
