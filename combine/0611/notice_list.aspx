<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notice_list.aspx.cs" Inherits="WebApplication1.notice_list" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="ctlBasicList" runat="server"
            AutoGenerateColumns="false"
             BorderWidth="10px" CellPadding="5" BorderStyle="None" HorizontalAlign="Center" OnRowCommand="ctl_RowCommand">
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText ="제목"
                         DataNavigateUrlFields ="title, ID, course_id, notice_id"
                         DataNavigateUrlFormatString="notice_show.aspx?current_id={1}&course_id={2}&notice_id={3}"
                         DataTextField="Title"
